...
class MIMICIIIBenchmarkDataset:
    def __init__(self, mimic3_benchmark_root, mimic3_root, split, transform=None):
        ...
        split_file = pd.read_csv(os.path.join(os.path.dirname(__file__), "..", "resources", "valset.csv"), header=None)
        ...
        # mimic3_benchmark_root: /workspaces/multimodal-mimic/mimic3-benchmarks/root/
