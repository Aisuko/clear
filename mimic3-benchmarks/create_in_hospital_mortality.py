    ...
    for patient in tqdm(patients, desc='Iterating over patients in {}'.format(partition)):
        ...
        for ts_filename in patient_ts_files:
            with open(os.path.join(patient_folder, ts_filename)) as tsfile:
                ...
                # skip patients who stayed in the ICU for less than n_hours 
                if los > n_hours - eps:
                    continue
                ...
                ts_lines = [line for (line, t) in zip(ts_lines, event_times) if -eps < t < "<the value here should be 6 -> 48 h>" + eps]
