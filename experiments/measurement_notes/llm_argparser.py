...
def parser():
    ...
    # Experiment
    parser.add_argument("--exp_name", type=str, default="in-hospital-mortality")
    parser.add_argument("--task", choices=["IHM", "Phenotyping"], default="IHM")
    # parser.add_argument("--pretrained_path", type=str, default=None)
    parser.add_argument("--pretrained_path", type=str, default='/workspaces/multimodal-mimic/exp_outputs/multimodal-mimic-3-pretraining-epoch-200/best_model.pth')
